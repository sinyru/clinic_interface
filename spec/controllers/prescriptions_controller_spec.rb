...
RSpec.describe PrescriptionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested prescription as @prescription" do
      prescription = Prescription.create! valid_attributes
      get :show, params: {id: prescription.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested prescription as @prescription" do
      prescription = Prescription.create! valid_attributes
      get :edit, params: {id: prescription.to_param}, session: valid_session
      expect(assigns(:prescription)).to eq(prescription)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Prescription" do
        expect {
          post :create, params: {prescription: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved prescription as @prescription" do
        post :create, params: {prescription: invalid_attributes}, session: valid_session
        expect(assigns(:prescription)).to be_a_new(Prescription)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested prescription" do
        prescription = Prescription.create! valid_attributes
        put :update, params: {id: prescription.to_param, prescription: new_attributes}, session: valid_session
        prescription.reload
      ...
      it "assigns the requested prescription as @prescription" do
        prescription = Prescription.create! valid_attributes
        put :update, params: {id: prescription.to_param, prescription: valid_attributes}, session: valid_session
        expect(assigns(:prescription)).to eq(prescription)
      end
    ...
    context "with invalid params" do
      it "assigns the prescription as @prescription" do
        prescription = Prescription.create! valid_attributes
        put :update, params: {id: prescription.to_param, prescription: invalid_attributes}, session: valid_session
        expect(assigns(:prescription)).to eq(prescription)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested prescription" do
      prescription = Prescription.create! valid_attributes
      expect {
        delete :destroy, params: {id: prescription.to_param}, session: valid_session
      }.to change(Prescription, :count).by(-1)
    end
